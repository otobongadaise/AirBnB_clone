...
```bash
git clone https://github.com/otobongadaise/AirBnB_clone.git
```
...
(hbnb) update User 1afa163d-486e-467a-8d38-3040afeaa1a1 email "otobongadaise@yahoo.com"
(hbnb) show User 1afa163d-486e-467a-8d38-3040afeaa1a1
[User] (s) [User] (1afa163d-486e-467a-8d38-3040afeaa1a1) {'id': '1afa163d-486e-467a-8d38-3040afeaa1a1', 'created_at': datetime.datetime(2022, 11, 24, 23, 42, 10, 502157), 'updated_at': datetime.datetime(2022, 11, 24, 23, 42, 10, 502186), 'email': 'otobongadaise@yahoo.com'}
(hbnb)

```
## Authors
<details>
    <summary>Otobong Adaise</summary>
    <ul>
    <li><a href="https://www.github.com/otobongadaise">Github</a></li>
    <li><a href="mailto:otobongadaise@yahoo.com">e-mail</a></li>
    </ul>
</details>
<details>
    <summary>Evy John</summary>
    <ul>
    <li><a href="https://www.github.com/glowblizzy">Github</a></li>
    <li><a href="mailto:eveshoyanblessing@gmail.com">e-mail</a></li>
    </ul>
</details>
